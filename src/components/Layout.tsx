    ...
    <>
      ...
      <footer className="w-full bg-card border-t py-6 px-4 text-center text-muted-foreground mt-8 shadow-inner">
        <div className="mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          <span className="font-semibold text-sm">© {new Date().getFullYear()} MED-IVRIT. All rights reserved.</span>
          <span className="text-sm">Made with <span className="text-red-500">♥</span> by MED-IVRIT Team</span>
        </div>
      </footer>
    </>
  );
